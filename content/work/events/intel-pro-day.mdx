...
A 4-day build for 1 day of show, out by midnight with no trace. The discipline is what carries forward: every script written down, every prop listed, every decision stamped with a client approval date. The line we designed the day to still holds. The technology supports the experience. It never interrupts it.
